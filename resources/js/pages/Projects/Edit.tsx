...
export default function Edit({ project }: any) {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setImagePreview(file ? URL.createObjectURL(file) : project.image_path);
    };
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Edit', href: `/projects/edit/${project.id}` }, // or just '#' if no link
            ]}
        >
